...
mkdir -p "${DUO_DIR}"/{roles,coordination,quality,taste,handoffs,reviews}
...
echo "  1. Edit .duo/coordination/context-map.md — map your codebase"
echo "  2. Edit .duo/taste/principles.md — inject your preferences"
echo "  3. Add tasks to .duo/coordination/task-board.md"
echo "  4. Run: duo build   (start Claude Code as Builder)"
echo "  5. Run: duo review  (start Codex as Reviewer)"
